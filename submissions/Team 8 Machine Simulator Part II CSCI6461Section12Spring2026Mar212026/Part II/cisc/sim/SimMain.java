...
public class SimMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            mem.poke(0, encodeLS(063, 1, 0, 0, 0)); // CHK R1, devid=0
            mem.poke(1, encodeLS(061, 0, 0, 0, 0)); // IN R0, devid=0
            mem.poke(2, encodeLS(062, 0, 0, 0, 1)); // OUT R0, devid=1
            mem.poke(3, (short) 0); // HLT
            r.setPC(0);
            ...
            mem.poke(0, encodeLS(01, 0, 0, 0, 020)); // LDR R0,0,20
            mem.poke(1, encodeLS(01, 1, 0, 0, 020)); // LDR R1,0,20
            mem.poke(2, (short) 0);                  // HLT
            r.setPC(0);
            System.out.println(cpu.executeLoadStoreStep());
